		...
		<div class="container-fluid page-body-wrapper">
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<a href="{{URL::to('exam_fetch')}}">	
							<div class="card text-center text-primary" style="height:350px;">
								<div class="card-body pb-0">
								<img src="dashboard/images/exam.png" alt="" style="width:100px; height:100px"><h2 class="mt-3 text-blue mb-3 font-weight-bold"><a href="{{URL::to('exam_fetch')}}" class="" style="text-decoration:none;">Exam schedule</a>
									</h2>

									<div class="ms-lg-5 d-lg-flex d-none">
										<h4 class="mt-3" style="margin-right:40px;">subject</h4>
						...
						<a href="#" style="text-decoration:none;">
							<div class="card congratulation-bg text-center" style="height:200px;">
								<div class="card-body pb-0">
								<img src="dashboard/images/seminar.png"  alt="" style="width:100px; height:80px; margin-top:-13px;">
							...
							<div class="card text-center text-primary" style="height:200px;">
							<a href="#">
								<div class="card-body pb-0">
									<img src="dashboard/images/attendance.png" alt="" style="width:100px; height:100px">  
									<h2 class="mt-3 text-blue mb-3 font-weight-bold"><a href="#" class="" style="text-decoration:none;">Attendance</a>
									</h2>
